...
const I18N = {
  pt: {
    ...
    lenteTrabalho: 'Etapa', lentePagamento: 'Pagamento',
    ...
    aVender: 'a vender', aCair: 'a cair na conta', liqParte: 'na conta', dinheiro: 'Dinheiro',
    colEsperandoPgto: 'Esperando pagamento', esperandoPgto: 'ESPERANDO PGTO', btnPraFila: 'Pra fila', aprovadoSelo: 'aprovado',
    colFila: 'Na fila', colFazendo: 'Fazendo', colEntregue: 'Entregue / concluído', colAprovado: 'Aprovado', colPago: 'Pago', colVazia: 'vazio', proximo: 'PRÓXIMO', fazerProximo: 'Fazer esse ser o próximo', maisNaFila: 'na fila', colFalta: 'falta receber', verTodos: 'ver todos', verRecentes: 'ver só recentes',
    ...
    navCofre: 'Cofre',
    verPatch: 'Ver patch', patchTitulo: 'O que mudou em cada versão',
    semPrazos: 'nenhum', dispensar: 'Dispensar lembrete',
    prazoAtrasado: 'd atrasado', prazoHoje: 'é HOJE', prazoAmanha: 'amanhã',
    prazoEm: 'em', prazoDias: 'dias',
    erroMidia: 'Não consegui salvar a mídia.',
    erroImagem: 'Não consegui gerar a imagem:', erroGif: 'Não consegui gerar o GIF:',
    gerandoGif: 'Gerando GIF…',
    metaSemEscolha: 'Escolha uma meta na aba Insígnias',
    metaFalta: 'faltam', metaQuase: 'é agora!',
    definirMeta: 'Definir como meta', metaAtiva: 'É a sua meta',
    palpite: 'Adivinhar na captura rápida',
    palpiteSub: 'Ao abrir com Ctrl+Shift+N, lê o nome da janela do Discord e o texto copiado, e sugere cliente, valor e prazo. Nada é preenchido sozinho — você clica na sugestão pra usar.',
    ...
    editar: 'Editar', excluir: 'Excluir', editarPedido: 'Editar pedido', salvarMudancas: 'Salvar mudanças',
  ...
  en: {
    ...
    lenteTrabalho: 'Stage', lentePagamento: 'Payment',
    ...
    aVender: 'to sell', aCair: 'to land', liqParte: 'in account', dinheiro: 'Money',
    colEsperandoPgto: 'Awaiting payment', esperandoPgto: 'AWAITING PAY', btnPraFila: 'To queue', aprovadoSelo: 'approved',
    colFila: 'Queue', colFazendo: 'Doing', colEntregue: 'Delivered / done', colAprovado: 'Approved', colPago: 'Paid', colVazia: 'empty', proximo: 'NEXT', fazerProximo: 'Make this the next one', maisNaFila: 'in queue', colFalta: 'still owed', verTodos: 'see all', verRecentes: 'recent only',
    ...
    navCofre: 'Savings',
    verPatch: 'Patch notes', patchTitulo: 'What changed in each version',
    semPrazos: 'none', dispensar: 'Dismiss reminder',
    prazoAtrasado: 'd late', prazoHoje: "it's TODAY", prazoAmanha: 'tomorrow',
    prazoEm: 'in', prazoDias: 'days',
    erroMidia: "Couldn't save the media.",
    erroImagem: "Couldn't render the image:", erroGif: "Couldn't build the GIF:",
    gerandoGif: 'Building GIF…',
    metaSemEscolha: 'Pick a goal in the Badges tab',
    metaFalta: 'still needs', metaQuase: 'almost there!',
    definirMeta: 'Set as goal', metaAtiva: 'This is your goal',
    palpite: 'Guess on quick capture',
    palpiteSub: 'When you open it with Ctrl+Shift+N, it reads the Discord window name and the copied text, and suggests client, amount and deadline. Nothing is filled in for you — click a suggestion to use it.',
    ...
    tut5d: 'Whenever a payment lands, Crava reminds you how much to set aside. You save it, take it out when you need it, and the history shows where it went.',
    ...
    editar: 'Edit', excluir: 'Delete', editarPedido: 'Edit job', salvarMudancas: 'Save changes',
    ...
    cofreEsteMes: 'Saved this month', cofreEntrouTudo: 'Total put in',
    cofreSaiuTudo: 'Taken out', cofreAguardando: 'Waiting for you to set aside',
    cofreHistoricoRot: 'Activity', cofreVazio: 'Nothing saved yet. The first payment that lands will remind you.',
